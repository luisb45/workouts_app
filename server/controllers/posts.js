...
export const updatePost = async (req, res) => {
    ...
    const updatedPost = await PostExercise.findByIdAndUpdate(_id, {...post, _id}, {new: true})
...
export const likePost = async (req, res) => {
    ...
    const updatedPost = await PostExercise.findByIdAndUpdate(id, {likeCount: post.likeCount + 1 }, { new: true })
